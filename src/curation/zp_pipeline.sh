...
python3 ../scripts/zp_fish_data.py id_map.tsv zp_zfin_phenotype_fish.tsv
python3 ../scripts/zp_kb.py id_map.tsv zp_zfin_phenoGeneCleanData_fish.tsv kb_zp.ttl
